...
const Form = ({type, post, setPost, submitting, handleSubmitting}) => {
    ...
    return (
        <section className="w-full max-w-full flex-start flex-col">
            ...
            <p className="desc text-left max-w-md"> {type} and share amazing prompt with the world and let your
            ...
            <form onSubmit={handleSubmitting} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
                <label><span className="font-satoshi font-semibold text-base text-gray-700">Your AI Prompt</span>
                    ...
                    /></label>
                <label>Tag {" "} <span className="font-satoshi font-semibold text-base text-gray-700">(#product, #webdevelopment, #idea)</span>
                    <input
